  ...
  return (
    <ProjectPage className="Projects" id="project">
      ...
      <DescriptionConatiner>
        ...
        <Em> typescript와 tailwind</Em> 사용에 익숙해지기 위한 목적으로 구현하였습니다.
        <P />
      ...
      <Project
        img={JSON.stringify([loadImg.PP1, loadImg.PP2, loadImg.PP3, loadImg.PP4])}
        title="PetPlace"
      ...
      />
      <DescriptionConatiner>
        ◻︎ 유저관리의 경우 <Em>소셜로그인</Em>은 물론, 보안을 위해 <Em>JWT Token</Em>을 기반으로
        유저를 관리 하였습니다.
        <P />
        ◻︎ 위치기반 서비스임에 중점을 두고, <Em>kakaoMap</Em>을 사용해 위치정보를 불러온 후,
        직선거리 계산을 이용해 근거리순을 제공하였습니다.
        <P />
        ◻︎ 사업자와 유저의 소통을 위해 <Em>단방향 통신인 SSE</Em>를 활용해 실시간 알림기능을
        제공하였습니다.
        <P />
        ◻︎ <Em>웹 사이트 성능 최적화</Em>를 통해 Lighthouse Perfomance점수를 73점에서 97점으로,
        Accessability 점수를 68점에서 87점으로 향상시켰습니다.
        <p /> 또한 <Em>React.lazy와 Suspense를 활용해</Em> 초기 렌더링 속도를 28.5% 감소
        시켰습니다.(0.7s → 0.5s)
      </DescriptionConatiner>
    </ProjectPage>
  );
